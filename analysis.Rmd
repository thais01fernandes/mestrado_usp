...
banco_completo %>% select(cod_munic,
  ...
  rename(plano_municipal_de_transporte = plano_municipal_de_transporte_existencia, 
         plano_de_mobilidade_urbana = possui_plano_de_mobilidade_urbana, 
         conselho_municipal_de_transporte = conselho_municipal_de_transporte_existencia, 
         fundo_municipal_de_transporte = fundo_municipal_de_transporte_existencia, 
         Ensino_superior_completo =  `Ensino superior completo`, 
         Especializacao = Especialização,
         prosperidade_muito_alta = `Muito Alto`,
         prosperidade_alta = Alto) %>%  View()
