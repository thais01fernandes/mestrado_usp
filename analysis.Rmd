...
banco_completo %>% 
  ...
  kbl(col.names = c("Caracterização do orgão gestor", "Cidades sem Tarifa Zero", "Cidades com Tarifa Zero"), caption = "Tabela 1: Caracterização do Orgão Gestor") %>%
...
kbl(col.names = c("Escolaridade", "Cidades sem Tarifa Zero", "Cidades com Tarifa Zero"), caption = "Tabela 2: Escolaridade do Titular do Orgão Gestor") %>%
kable_classic(full_width = F , html_font = "Cambria") %>% 
footnote(general = "IBGE, 2021 ",
           general_title = "Fonte: ", number_title = "Type I: ",
           footnote_as_chunk = T, title_format = c("italic")
...
banco_completo %>% 
  ...
  adorn_pct_formatting(digits = 0) %>% 
kbl(col.names = c("Existe Conselho na Cidade?", "Cidades sem Tarifa Zero", "Cidades com Tarifa Zero"), caption = "Tabela 3: Existência de Conselho Municipal de Transporte") %>%
kable_classic(full_width = F , html_font = "Cambria") %>% 
footnote(general = "IBGE, 2021 ",
           general_title = "Fonte: ", number_title = "Type I: ",
           footnote_as_chunk = T, title_format = c("italic")
...
banco_completo %>%
  ...
  adorn_pct_formatting(digits = 0) %>% 
kbl(col.names = c("Existe Fundo Municipal?", "Cidades sem Tarifa Zero", "Cidades com Tarifa Zero"), caption = "Tabela 4: Existência de Fundo Municipal de Transporte") %>%
kable_classic(full_width = F, html_font = "Cambria") %>% 
footnote(general = "IBGE, 2021 ",
           general_title = "Fonte: ", number_title = "Type I: ",
           footnote_as_chunk = T, title_format = c("italic")
...
banco_completo %>% 
  ...
  adorn_pct_formatting(digits = 0) %>% 
kbl(col.names = c("Existe Plano de Mobilidade Urbana?", "Cidades sem Tarifa Zero", "Cidades com Tarifa Zero"), caption = "Tabela 5: Existência de Plano de Mobilidade Urbana") %>%
kable_classic(full_width = F, html_font = "Cambria") %>% 
footnote(general = "IBGE, 2021 ",
           general_title = "Fonte: ", number_title = "Type I: ",
           footnote_as_chunk = T, title_format = c("italic")
...
select(-tarifa_zero) %>% 
kbl(col.names = c("Regime de Contratação", "Cidades sem Tarifa Zero", "Cidades com Tarifa Zero"), caption = "Tabela 7: Regime de Contratação dos Funcionários da Administração Direta") %>%
kable_classic(full_width = F , html_font = "Cambria") %>% 
footnote(general = "IBGE, 2021 ",
           general_title = "Fonte: ", number_title = "Type I: ",
           footnote_as_chunk = T, title_format = c("italic")
